...
[NOME DO(A) DISCENTE]. Trabalho apresentado à disciplina de Ciência de Dados. [NOME DO(A) DOCENTE].

---

# SUMÁRIO

O sumário automático e a paginação definitiva serão aplicados na revisão ABNT (Etapa 15).
